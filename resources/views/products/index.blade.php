<x-app-layout>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{ route('products.create') }}" class="btn btn-primary shadow-md mr-2">Novo</a>
                ...
                <tbody>
                    @foreach ($products as $product)
                        <tr class="intro-x">
                            ...
                            <td>
                                <a href="javascript:;" class="font-medium whitespace-nowrap">{{ $product->active }}</a>
                            </td>
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <x-forms.buttons.edit :route="route('products.edit', $product->id)" />
                                    <x-forms.buttons.delete :route="route('products.destroy', $product->id)" />
                                </div>
                            </td>
                        </tr>
                    @endforeach
