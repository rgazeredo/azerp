<x-app-layout>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{ route('lines.create') }}" class="btn btn-primary shadow-md mr-2">Novo</a>
            ...
            <table class="table table-report -mt-2">
                ...
                <tbody>
                    @foreach ($lines as $line)
                        <tr class="intro-x">
                            <td>
                                <a href="javascript:;" class="font-medium whitespace-nowrap">{{ $line->name }}</a>
                            </td>
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <x-forms.buttons.edit :route="route('lines.edit', $line->id)" />
                                    <x-forms.buttons.delete :route="route('lines.destroy', $line->id)" />
                                </div>
                            </td>
                        </tr>
                    @endforeach
